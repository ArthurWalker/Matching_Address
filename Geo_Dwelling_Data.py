...
def main():
    ...
    #dwelling_df = pd.read_csv(path+'BLank_Cant_Find_Empty.csv',skipinitialspace=True,low_memory=False).fillna('')
    dwelling_df = pd.read_csv('EMPTY_MPRN_COUNTY.csv', skipinitialspace=True, low_memory=False).fillna('')
    ...
    no_mprn_county_df_results.to_csv(path_or_buf='Empty_MPRN_county_results.csv', index=None, header=True)
    ...
    #dwelling_df_counties_replace.to_csv(path_or_buf='Empty_MPRN_county_results.csv', index=None, header=True)
